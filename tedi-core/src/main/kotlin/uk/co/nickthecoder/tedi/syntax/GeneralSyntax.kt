 ...
 */
fun syntax(text: String, pattern: Pattern, styleMap: Map<String, Highlight?>): List<HighlightRange> {
    ...
    while (catchMatcherFind()) {
        findHighlight()?.let { ranges.add(HighlightRange(matcher.start(), matcher.end(), it)) }
    }
